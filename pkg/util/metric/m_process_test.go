...
func TestProcessCollectorNormal(t *testing.T) {
	Convey("collect proc cpu and mem succ", t, func() {
		...
		reg.MustRegister(newBatchStatsCollector(NewProcCpuPercent(), procMemUsage{}, procCpuTotal{}))
...
func TestProcessError(t *testing.T) {
	...
	Convey("collect error", t, func() {
		reg := prom.NewRegistry()
		reg.MustRegister(newBatchStatsCollector(NewProcCpuPercent(), procMemUsage{}, procOpenFds{}, procFdsLimit{}, procCpuTotal{}))
