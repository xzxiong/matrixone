...
var stringPrefix = func(ip string) bool {
	return len(ip) > 7 &&
		...
		ip[:4] == "127." ||
			...
			ip[:3] == "10." ||
			ip[:8] == "192.168." /*192.168.0.0 ~ 192.168.255.255*/ ||
			ip[:8] == "169.254." ||
			// 172.16.0.0 ~ 172.31.255.255
			((ip[:7] == "172.16.") || (ip[:7] == "172.17.") || (ip[:7] == "172.18.") || (ip[:7] == "172.19.") ||
				(ip[:7] == "172.20.") || (ip[:7] == "172.21.") || (ip[:7] == "172.22.") || (ip[:7] == "172.23.") ||
				(ip[:7] == "172.24.") || (ip[:7] == "172.25.") || (ip[:7] == "172.26.") || (ip[:7] == "172.27.") ||
				(ip[:7] == "172.28.") || (ip[:7] == "172.29.") || (ip[:7] == "172.30.") || (ip[:7] == "172.31.")) ||
			// Ipv6 loopback
			ip == "::1" ||
